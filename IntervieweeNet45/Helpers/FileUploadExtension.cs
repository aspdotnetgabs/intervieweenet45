...
public static class FileUploadExtension
{
    ...
    public static string SaveToFolder(this HttpPostedFileBase File, string strFileName = "", string strFolder = "", bool NoOverwrite = true)
    {
        ...
        string filenameExt = (NoOverwrite ? filename + "_" + GenerateUniqueChars() : filename) + Path.GetExtension(File.FileName);
